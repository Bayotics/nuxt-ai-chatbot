<template>
    <div class="auth-container">
      <div v-if="auth.isLoading" class="flex justify-center items-center h-40">
      ...
      <div v-else-if="auth.isAuthenticated" class="text-center">
        <div class="flex items-center justify-center mb-4">
          <div 
            ...
            :style="{ backgroundColor: getUserColor(auth.user?.id) }"
          >
            <span class="text-xl font-bold text-white">
              {{ auth.user?.firstName?.charAt(0) || auth.user?.username?.charAt(0) || 'U' }}
            </span>
          </div>
        </div>
        ...
        <div v-if="showRegister" class="register-form">
          ...
          <form @submit.prevent="handleRegister" class="space-y-4">
            ...
            <div class="flex justify-between">
              ...
              <button
                type="submit"
                class="px-6 py-2 bg-primary-600 text-white hover:bg-primary-700 rounded-md transition-colors"
                :disabled="auth.isLoading"
              >
                <span v-if="auth.isLoading">Creating...</span>
